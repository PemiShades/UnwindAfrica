...
urlpatterns = [
    ...
    path('edbritish-trial/', views.edbritish_trial, name='edbritish_trial'),
    path('edbritish-trial/register/', views.edbritish_trial_registration, name='edbritish_trial_registration'),
